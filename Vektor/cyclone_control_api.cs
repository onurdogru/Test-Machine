...
namespace Vektor
{
    public static class cyclone_control_api
    {
        ...
        public const string TargetProperties = "targetProperties";
          public const string selectTargetPropertyTargetVoltageReading = "targetVoltageReading";
          public const string selectTargetPropertyTargetCurrentReading = "targetCurrentReading";
          public const string selectTargetPropertyTargetObjectCrc = "targetObjectCrc";
          public const string selectTargetPropertyTargetDeviceCrc = "targetDeviceCrc";
        ...
        public const string DLL_FILENAME = "..\\..\\bin\\Debug\\CycloneControlSDK.dll";
        ...
        private static extern IntPtr unmanaged_getDescriptionOfErrorCode(UInt32 cycloneHandle, Int32 errorCode);
        ...
        public static string getDescriptionOfErrorCode(UInt32 cycloneHandle, Int32 errorCode)
        {
